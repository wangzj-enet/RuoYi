package com.ruoyi.project.pdd.pddGoodsDataAdd.domain;
...
public class PddGoodsDataAdd extends BaseEntity
{
	...
	/** 商品轮播图 */
	private String localCarouselGallery;
	/** 商品详情图 */
	private String detailGallery;
	/** 商品详情图 */
	private String localDetailGallery;
	/** 是否支持正品发票 */
	...
	public void setLocalCarouselGallery(String localCarouselGallery) 
	{
		this.localCarouselGallery = localCarouselGallery;
	}

	public String getLocalCarouselGallery() 
	{
		return localCarouselGallery;
	}
	...
	public void setLocalDetailGallery(String localDetailGallery) 
	{
		this.localDetailGallery = localDetailGallery;
	}

	public String getLocalDetailGallery() 
	{
		return localDetailGallery;
	}
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("localImageUrl", getLocalImageUrl())
            .append("carouselGallery", getCarouselGallery())
            .append("localCarouselGallery", getLocalCarouselGallery())
            .append("detailGallery", getDetailGallery())
            .append("localDetailGallery", getLocalDetailGallery())
