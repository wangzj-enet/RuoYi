package com.ruoyi.project.pdd.pddGoodsMainStatus.mapper;
 ...
 * @date 2019-08-02
 */
public interface PddGoodsMainStatusMapper 
{
	/**
     * 查询主记录状态信息
     * 
     ...
     * @return 结果
     */
	public int deletePddGoodsMainStatusById(Long mainStatusId);
	
	/**
     * 批量删除主记录状态
     * 
     * @param mainStatusIds 需要删除的数据ID
     * @return 结果
     */
	public int deletePddGoodsMainStatusByIds(String[] mainStatusIds);
